...
async function buildServer() {
  const fastify = Fastify({
    logger: fastifyLoggerOptions, // ✅ correct for Fastify
  ...
  // ✅ IMPORTANT: if you use prefix "/evaluate", then inside routes file
  // your route should be fastify.post("/") not fastify.post("/evaluate")
