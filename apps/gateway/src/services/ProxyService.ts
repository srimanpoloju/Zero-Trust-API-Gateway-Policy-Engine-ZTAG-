...
export class ProxyService {
  static async proxyRequest(
    ...
    try {
      ...
      const fetchOptions: Parameters<typeof undiciRequest>[1] = {
        method,
        ...
        ...(body && ['POST', 'PUT', 'PATCH'].includes(method) && { duplex: 'half' as 'half' }),
      ...
      const downstreamResponseHeaders: Record<string, string> = {};
